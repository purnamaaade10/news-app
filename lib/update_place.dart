...
class _UpdatePlaceState extends State<UpdatePlace> {
  ...
  void iniState() {
    ...
    openDayController.text = widget.place.open_day;
    openHourController.text = widget.place.open_hours;
    ticketPriceController.text = widget.place.ticket_price;
  }

  createPlace(String name, String location, String description, String openDay,
      String openHour, String ticketPrice, File image, int id) async {
    final uri = 'http://192.168.1.9:8000/api/place/update/$id';
